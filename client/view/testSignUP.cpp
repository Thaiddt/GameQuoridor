...
void texturesAndFonts()
{
    inika.loadFromFile("./../fonts/Inika-Regular.ttf");
    jasque.loadFromFile("./../fonts/Jasques.ttf");
    background.loadFromFile("./../assets/background.png");
    fieldusername.loadFromFile("./../assets/username.png");
    fieldpassword.loadFromFile("./../assets/username.png");
    fieldcfpassword.loadFromFile("./../assets/username.png");
    buttonsignup.loadFromFile("./../assets/signup.png");
    buttonback.loadFromFile("./../assets/back.png");
}
void drawSignup(signUp_box box)
{
